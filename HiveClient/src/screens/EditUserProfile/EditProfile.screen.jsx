          ...
          <div className="tabordion">
              ...
              <article>
                <div className="frm">
                  ...
                  <label className="label" for="textarea">
                    SHORT BIOGRAPHY<p id="count"></p>
                  </label>
                  <textarea
                    className="textarea e"
                    rows="7"
                    cols="25"
                    id="bio"
                    maxlength="500"
            ...
            <section id="section3">
              ...
              <article>
                <div className="tr wwq">
                  {/* Current Password */}
                  <label className="label" for="currentPassword">
                    Current Password
                  </label>
                  <input
                    className="input e"
                  ...
                  {/* New Password */}
                  <label className="label" for="newPassword">
                    New Password
                  </label>
                  <input
                    className="input e"
            ...
            <section id="section4">
              ...
              <label for="option4" className="trr">
                Verify
              </label>
              <article>
                <p>
                  The green verified badge <span className="ver">&#10026;</span>{" "}
                  on ZIki lets people know that an account is authentic.
                </p>
              </article>
            </section>
          </div>
