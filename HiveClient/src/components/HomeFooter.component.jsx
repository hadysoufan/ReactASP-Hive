            ...
            <div className="container py-4 py-lg-5">
                <div className="row row-cols-2 row-cols-md-4">
                    <div className="col-12 col-md-3">
                        <div className="fw-bold d-flex align-items-center mb-2"><span>Hive</span></div>
                    ...
                    <div className="col-sm-4 col-md-3 text-lg-start d-flex flex-column">
                        ...
                        <ul className="list-unstyled">
                            <li><a href="http://example.com">Web design</a></li>
                            <li><a href="http://example.com">Development</a></li>
                            <li><a href="http://example.com">Hosting</a></li>
                        </ul>
                    </div>
                    <div className="col-sm-4 col-md-3 text-lg-start d-flex flex-column">
                        <h3 className="fs-6 fw-bold">About</h3>
                        <ul className="list-unstyled">
                            <li><a href="http://example.com">Company</a></li>
                            <li><a href="http://example.com">Team</a></li>
                            <li><a href="http://example.com">Legacy</a></li>
                        </ul>
                    </div>
                    <div className="col-sm-4 col-md-3 text-lg-start d-flex flex-column">
                        <h3 className="fs-6 fw-bold">Careers</h3>
                        <ul className="list-unstyled">
                            <li><a href="http://example.com">Job openings</a></li>
                            <li><a href="http://example.com">Employee success</a></li>
                            <li><a href="http://example.com">Benefits</a></li>
                        </ul>
                    </div>
                </div>
                <hr />
                <div className="text-muted d-flex justify-content-between align-items-center pt-3">
                    <p className="mb-0">Copyright © 2023 Hive</p>
